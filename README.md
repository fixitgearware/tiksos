...
|  <strong>Burpsuite</strong>  |    Installation.  | 1. Type the command below, to check for the version of installed Burpsuite.
   Burpsuite -v [fires up burpsuite, and shows which version]
