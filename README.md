...
|  <strong>Burpsuite</strong>  |    Installation.  | 1. Type the command below, to check for the version of installed Burpsuite.<br><strong>Burpsuite -v</strong><br>[fires up burpsuite, and shows which version]<br> 2.Head to Portswigger academy, to download the <strong>*.jar</strong> file for Burpsuite into your computer.<br>3. Navigate to Downloads on your Kali.  Using the <strong>“cd Downloads”</strong> command, in your terminal.4.  From the download directory, type the command below, to rename the *.jar file of the version of Burpsuite downloaded.  sudo mv burpsuite_community_v2023.11.1.3.jar burpsuite This will rename “burpsuite_community_v2023.11.1.3.jar” to “Burpsuite”|
